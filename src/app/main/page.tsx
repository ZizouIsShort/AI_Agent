...
export default function MainPage() {
  ...
  return (
    <div className="flex h-screen w-full flex-col bg-[#131314] text-[#e3e3e3] selection:bg-[#3d4451]">
      ...
      {/* Floating Input Area */}
      <footer className="w-full bg-[#131314] px-4 pb-6 pt-2">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-3 text-center text-[11px] tracking-wide text-[#8e918f]">
            Ziyan ka AI agent <span className="mx-1">•</span> (Inshallah it
            works)
          </p>
        </div>
      </footer>
